...
<!-- Mirrored from htmldemo.net/joshua/joshua/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Apr 2024 11:26:51 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-9">
                            <div class="main-menu-inner">
                                ...
                                <nav class="main-menu">
                                    <ul>
                                        <li class="active"><a href="index">Home <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown">
                                                <li><a href="index">Home version 01</a></li>
                                                <li><a href="index-2">Home version 02</a></li>
                                                <li><a href="index-3">Home version 03</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="about">About Us</a></li>
                                        <li><a href="appointment"> Appointment </a></li>
                                        <li><a href="service">Services <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 order-1">
                        ...
                        <div class="blog-post-item">
                            <div class="blog-thumb details-thumb">
                                <img src="assets/img/blog/details-1.jpg" alt="blog image">
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="coment-btn">
                                                <input class="btn btn-theme" type="submit" name="submit" value="POST COMMENT">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from htmldemo.net/joshua/joshua/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Apr 2024 11:26:52 GMT -->
</html>